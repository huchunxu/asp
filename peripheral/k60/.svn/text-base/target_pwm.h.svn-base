...
/*各模块周期相关计数次数定义*/
#define FTM0_PWM_CYCLE 62500       /* 50M时钟  8分频(3) :6.25M 10ms   随动舵机控制  */
#define FTM1_PWM_CYCLE 6250        /* 50M时钟   8分频(3)   1ms  电机控制     */
#define FTM2_PWM_CYCLE 25000       /* 50M时钟   8分频(3)  4ms    转向舵机控制  */
