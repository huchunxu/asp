 ...
 */
/* 摄像头组 */
#define   SWITCH_START0      ((SWITCH_START0_PIN<<16) | 0x0000)
#define   SWITCH_START1      ((SWITCH_START1_PIN<<16) | 0x0001)
...
#define   SWITCH4            ((SWITCH4_PIN<<16)  | 0x0006)
#define   SWITCH5            ((SWITCH5_PIN<<16)  | 0x0007)
#define   SWITCH6            ((SWITCH6_PIN<<16)  | 0x0008)  
#define   SWITCH7            ((SWITCH7_PIN<<16)  | 0x0009)
