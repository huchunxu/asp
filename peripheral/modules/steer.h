 ...
 * 舵机的最值角度定义
 */
#define   STEER_DIR_MAX_ANGLE             30
#define   STEER_DIR_MIN_ANGLE            -30
 ...
 * 舵机的最值计数值定义
 */
#define   STEER_DIR_MAX_VALUE             2500
#define   STEER_DIR_MIN_VALUE             -2500

#define   STEER_SERVO_MAX_VALUE           2250
#define   STEER_SERVO_MIN_VALUE          -2250

/** 
 * 舵机的中心值定义
 */
#define   STEER_DIR_CENTER      9500
#define   STEER_SERVO_CENTER    9500

/** 
 * 舵机的左右步长定义
 */
#define   LEFT_STEER_DIR_PRES      30
#define   RIGHT_STEER_DIR_PRES     30
 ...
 *    @brief   steer初始化
 */
void steer_init(intptr_t exinf);
