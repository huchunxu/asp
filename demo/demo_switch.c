 ...
 */
void demo_switch_initialize(intptr_t exinf)
{
            ...
            case 'd':
                ...
                else
                {
                    ...
                    if (switch_read(SWITCH_START0))
                        puts("The switch start0 is ON\n");
                    else
                    	puts("The switch start0 is OFF\n");

                    if (switch_read(SWITCH_START1))
                    	puts("The switch start1 is ON\n");
                    else
                    	puts("The switch start1 is OFF\n");
                }
                break;
