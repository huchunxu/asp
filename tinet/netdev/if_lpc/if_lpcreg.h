 ...
 * 
 *  @(#) $Id: if_lpcreg.h,v 1.5 2011/01/18 $
 */

#ifndef _If_LPCREG_H_
#define _If_LPCREG_H_
//#include "LPC24xx.h"
...
#define NUM_RX_FRAG         7           /* Num.of RX Fragments 6*1536= 12K Bytes */
#define NUM_TX_FRAG         3           /* Num.of TX Fragments 4*1536= 3K Bytes */
