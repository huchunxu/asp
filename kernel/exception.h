...
/*
 *  CPU expception handler init block
 */
typedef struct cpu_exception_handler_initialization_block {
	EXCNO		excno;			/* CPU exception no */
	ATR			excatr;			/* CPU exception attribute*/
	FP			exc_entry;		/* CPU exception entry address */
} EXCINIB;

/*
 *  total number of cpu exception handler (see kernel_cfg.c)
 */
extern const uint_t	tnum_excno;

/*
 *  cpu  handler init block array (see kernel_cfg.c)
 */
...
/*
 *  CPU exception handler initialization
 */
